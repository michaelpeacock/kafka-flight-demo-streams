...
public class CurrentFlightCounter {
    public static void main(String[] args) {
        System.out.println("In CurrentFlightCounter...");
        Properties config = new Properties();
        config.put(StreamsConfig.APPLICATION_ID_CONFIG, "current-flight-counter-app2");
        ...
        KTable<String, Long> uniquesFlightCountsByKey = flights
                ...
                .groupByKey()
                .count();
        uniquesFlightCountsByKey.toStream().to("flights-by-key", Produced.with(Serdes.String(), Serdes.Long()));

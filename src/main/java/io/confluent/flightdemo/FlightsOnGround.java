...
public class FlightsOnGround {
    public static void main(String[] args) {
        System.out.println("In FlightsOnGround...");
        Properties config = new Properties();
        config.put(StreamsConfig.APPLICATION_ID_CONFIG, "current-flights-on-ground-counter-app");
        ...
        KTable<String, Long> uniquesFlightCountsByKey = flights
                ...
                .selectKey((key, value) -> {
                    ...
                    return "flights-on-ground-counts";
                })
                .groupByKey()
                .count();
        uniquesFlightCountsByKey.toStream().to("flights-on-ground", Produced.with(Serdes.String(), Serdes.Long()));
